                        ...
                        <div className="w-full md:w-[24%] lg:w-[24%] bg-[#e3e3e3] rounded-md mb-5">
                            <div className="flex justify-start pb-3 mt-3">
                                <div className="pl-3 mr-3">
                                    ...
                                    <div className="w-20">
                                        <Link href="#" className="text-[#FFF] hover:text-[#000000] text-center flex justify-around py-1 bg-[#009c12] hover:bg-[#e3e3e3] border-2 border-[#009c12] text-[12px] rounded-md">Checklist</Link>
                                    </div>
                                </div>
                                <div className="relative w-20 h-20">
                                    <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
                                        <circle className="text-[#FFF]" strokeWidth="2" stroke="currentColor" fill="transparent" r="40" cx="50" cy="50" />
                                        <circle className="text-[#009c12] rounded-lg"strokeWidth="5" stroke="currentColor" fill="transparent" r="40" cx="50" cy="50"
                    ...
                    <div className="flex flex-wrap justify-start gap-3">
                        ...
                        <div className="w-full md:w-[24%] bg-[#e3e3e3] rounded-md overflow-hidden">
                            <div className="flex justify-center items-center pb-3 mt-3">
                                <div className="flex items-center justify-center p-3 bg-[#009c12] rounded-md ml-3">
                                    <svg className="w-6 h-6 text-[#FFF] bg-[#009c12] dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <Link href="/my-tasks" className="text-[#FFF] hover:text-[#000000] text-center flex justify-around py-2 bg-[#009c12] hover:bg-[#e3e3e3] border-2 border-[#009c12]">Go To Task Management</Link>
                        </div>
                        <div className="w-full md:w-[24%] bg-[#e3e3e3] rounded-md overflow-hidden">
                            <div className="flex justify-center items-center pb-3 mt-3">
                                <div className="flex items-center justify-center p-3 bg-[#009c12] rounded-md ml-3">
                            ...
                            <Link href="#" className="text-[#FFF] hover:text-[#000000] text-center flex justify-around py-2 bg-[#009c12] hover:bg-[#e3e3e3] border-2 border-[#009c12]">Go To Intranet</Link>
                        </div>
                        <div className="w-full md:w-[24%] bg-[#e3e3e3] rounded-md overflow-hidden">
                            <div className="flex justify-center items-center pb-3 mt-3">
                                <div className="flex items-center justify-center p-3 bg-[#009c12] rounded-md ml-3">
                            ...
                            <Link href="#" className="text-[#FFF] hover:text-[#000000] text-center flex justify-around py-2 bg-[#009c12] hover:bg-[#e3e3e3] border-2 border-[#009c12]">Start Trial</Link>
                        </div>
                        <div className="w-full md:w-[24%] bg-[#e3e3e3] rounded-md overflow-hidden">
                            <div className="flex justify-center items-center pb-3 mt-3">
                                <div className="flex items-center justify-center p-3 bg-[#009c12] rounded-md ml-3">
                        ...
                        <div className="w-full md:w-[24%] bg-[#e3e3e3] rounded-md overflow-hidden">
                            ...
                            <Link href="#" className="text-[#FFF] hover:text-[#000000] text-center flex justify-around py-2 bg-[#009c12] hover:bg-[#e3e3e3] border-2 border-[#009c12]">Go To CRM</Link>
                        </div>
                        <div className="w-full md:w-[24%] bg-[#e3e3e3] rounded-md overflow-hidden">
                            <div className="flex justify-center items-center pb-3 mt-3">
                                <div className="flex items-center justify-center p-3 bg-[#009c12] rounded-md ml-3">
                            ...
                            <Link href="#" className="text-[#FFF] hover:text-[#000000] text-center flex justify-around py-2 bg-[#009c12] hover:bg-[#e3e3e3] border-2 border-[#009c12]">Go To WhatsApp API</Link>
                        </div>
                        <div className="w-full md:w-[24%] bg-[#e3e3e3] rounded-md overflow-hidden">
                            <div className="flex justify-center items-center pb-3 mt-3">
                                <div className="flex items-center justify-center p-3 bg-[#009c12] rounded-md ml-3">
                            ...
                            <Link href="#" className="text-[#FFF] hover:text-[#000000] text-center flex justify-around py-2 bg-[#009c12] hover:bg-[#e3e3e3] border-2 border-[#009c12]">Go To Tutorial</Link>
                        </div>
                    </div>
                </div>
            </section>
